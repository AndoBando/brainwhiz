<?php 
    ...
    if (isset($_POST['upload'])){
        ...
        // We insert the image name into the database (you might want to change this to the image path), along witht the text and uploader
